...
Siguiendo la formula de memoria swap máxima:
```
Max memoria sawp = memory_swap - memory
```

```
Max memoria sawp = 1024 - 300 = 724 MB
```

Entonces la memoria swap que puede ocupar es de 724 MegaBytes
